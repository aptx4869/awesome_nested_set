    ...
    module NestedSet #:nodoc:
      module ActiveRecordModel
        class Move
          ...
          delegate :acts_as_nested_set_base_class, to: :instance_class, prefix: :instance
          ...
          def conditions(a, b, c, d)
            conditions_ = case_condition_for_direction(:quoted_left_column_name) +
            ...
            conditions_ << ', updated_at = :timestamp' if @instance.respond_to?(:updated_at)
          ...
          def lock_nodes_between!(left_bound, right_bound)
            ...
            instance_acts_as_nested_set_base_class
